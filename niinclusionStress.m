...
hold(axes1,'on');
box(axes1,'on');
scatter(X2(1:L(1)),Angs{k}(:,1),ba,'d','MarkerEdgeColor','k');hold on
scatter(X2(1:L(1)),Angs{k}(:,2),ba,'o','MarkerEdgeColor','r');hold on
scatter(X2(1:L(1)),Angs{k}(:,3),ba,'*','MarkerEdgeColor','b');hold on
xlabel('Distance from the rail top surface to the center of inclusion \it(mm)','FontName','Times New Roman', 'FontSize',ft);
ylabel('Principal plane unit normal vector components','FontName','Times New Roman',  'FontSize',ft);
title(['Directions of principal stress around inclusion at x=',num2str(l(k)),'mm'],'FontSize',ft)
...
xlabel('Distance from the rail top surface to the center of inclusion \it(mm)','FontName','Times New Roman', 'FontSize',ft);
ylabel('\it(\sigma_1)_{max} at inclusion \it(MPa)','FontName','Times New Roman',  'FontSize',ft);
...
quiver3(Str1(1:3,1:6),u11(1:3,1:6),v11(1:3,1:6),w11(1:3,1:6),0.5),hold on;
...
save Str1noi.txt -ascii -double Str1
